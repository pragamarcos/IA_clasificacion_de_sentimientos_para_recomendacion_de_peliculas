...
Mejorar retención: Usuarios encuentran películas que les encantarán (no solo "buenas películas")
...
bashgit clone https://github.com/TuUsuario/sentiment-analysis-imdb.git
...
bashjupyter notebook notebook/Trabajo_Final_Data_science_III.ipynb
Opción 3: Scripts Python
bash# Cargar datos y ejecutar EDA
...
Variar arquitectura de capas
Diferentes valores de Dropout


Data Augmentation

Sinónimos: reemplazar palabras con similares
Paráfrasis: reescribir oraciones manteniendo sentimiento
...
Word2Vec (genera vectores más semánticos)
GloVe (captura relaciones entre palabras)
FastText (maneja palabras no vistas)
...
Capturan orden y contexto de palabras
...
RoBERTa (mejorado sobre BERT)
Transfer learning desde modelos preentrenados


Análisis de Aspectos

Sentimiento por aspecto (guión, actuación, dirección)
Rankings comparativos por género
...
Reflexión Final
El 85.78% de accuracy validó nuestra metodología. Aunque el dataset IMDB es relativamente "fácil" (altamente polarizado), los principios aplicados son escalables a problemas más complejos:
...
👤 Autor
Marcos - Data Scientist | Coderhouse
...
🔗 LinkedIn: (https://www.linkedin.com/in/marcospraga/)
...
⏳ Futuro: API REST y dashboard interactivo
